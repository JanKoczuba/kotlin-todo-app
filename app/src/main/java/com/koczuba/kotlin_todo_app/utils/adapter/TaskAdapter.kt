package com.koczuba.kotlin_todo_app.utils.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.koczuba.kotlin_todo_app.databinding.EachTodoItemBinding
...
class TaskAdapter(private val list: MutableList<ToDoData>) :
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        with(holder) {
            with(list[position]) {
                binding.todoTask.text = this.taskDescription
